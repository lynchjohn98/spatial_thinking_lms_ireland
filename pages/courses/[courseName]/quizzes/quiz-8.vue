...
onMounted(async () => {
  ...
  if (error) {
    ...
    quiz.value.multipleChoiceQuestions = [
      quiz.value.multipleChoiceQuestions[0],
      quiz.value.multipleChoiceQuestions[1],
      quiz.value.multipleChoiceQuestions[2],
      quiz.value.multipleChoiceQuestions[6],
      quiz.value.multipleChoiceQuestions[7],
      quiz.value.multipleChoiceQuestions[8],
      quiz.value.multipleChoiceQuestions[9],
      quiz.value.multipleChoiceQuestions[20],
      quiz.value.multipleChoiceQuestions[21],
      quiz.value.multipleChoiceQuestions[22],
    ];
  }
});
</script>
