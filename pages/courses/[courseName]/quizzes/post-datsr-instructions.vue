...
<template>
  <div class="bg-emerald-600 flex flex-col h-full w-full">
    ...
    <div class="flex flex-col items-center justify-center p-5">
      ...
      >
        Look at the answer figures A, B, C, and D. Only one of these can be made
        from the pattern. Answer A is wrong because the top is not shaded.
        Answer B is wrong because one of the long sides is shaded, and the
        pattern shows that the long sides are not shaded. Answer C is wrong
        because the top is not shaded. The correct answer is D because the top
        and one of the short sides are shaded. The shaded bottom is hidden from
        view.
      </div>
      ...
      <p>
        ...
        pattern is folded, the roof will be shaded on two opposite sides. Notice
        that each of the four sides of the house has a window.
      </p>
      <img
        class="rounded-lg w-1/4"
      ...
      >
        Look at the answer figures A, B, C, and D. Only one of these can be made
        from the pattern. Answer A is wrong because the two shaded sides of the
        roof are next to each other, not on opposite sides. Answer B is wrong
        because all four sides of the roof are next to each other, not on
        opposite sides. Answer B is wrong because all four sides of the house
        are supposed to have windows. Answer D is wrong because one shaded side
        of the roof should be visible. The correct answer is C because one
        shaded side of the roof is visible and each visible side of the house
        has a window.
      </div>

      <p>
        Remember the pattern always shows the outside surface of the completed
        figure. Each answer figure is the correct shape, but only one figure can
        be made from the pattern. When you are ready, please use the link below
        to begin the DAT:SR Test.
      </p>
      <NuxtLink
