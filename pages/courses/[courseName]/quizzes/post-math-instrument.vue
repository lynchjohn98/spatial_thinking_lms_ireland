...
async function handleSubmit() {
  ...
  questionArray.forEach((item, index) => {
    finalJson[`question${index + 1}`] = item._value;
  });
  ...
  <div v-if="submittedQuiz === false" class="quiz-fullpage bg-emerald-700">
      ...
      <table>
        ...
        <tbody>
          <tr>
            <td>Shape I</td>
            <td>
              <select name="question2_a1" v-model="question2_a1" class="text-black">
          ...
          <tr>
            <td>Shape II</td>
            <td>
              <select name="question2_a2" v-model="question2_a2" class="text-black">
                <option disabled value="null">[ Select ]</option>
                <option value="Yes">Yes</option>
                <option value="No">No</option>
              </select>
          ...
          <tr>
            <td>Shape III</td>
            <td>
              <select name="question2_a3" v-model="question2_a3" class="text-black">
                <option disabled value="null">[ Select ]</option>
                <option value="Yes">Yes</option>
                <option value="No">No</option>
              </select>
    ...
    <h2 class="font-bold text-2xl">Question 3</h2>
      ...
      <div class="question-section mt-4">
        <h3>
          Part B: Here are pictures of five tracks: Along which one of these
        ...
        <!-- Insert images for the five tracks here -->
        <ul class="multiple-choice">
          <li>
            <input type="radio" name="partB" value="1" v-model="question3_b" />
            Track A
          </li>
          <li>
            <input type="radio" name="partB" value="2" v-model="question3_b" />
            Track B
          </li>
          <li>
            <input type="radio" name="partB" value="3" v-model="question3_b" />
            Track C
          </li>
          <li>
            <input type="radio" name="partB" value="4" v-model="question3_b" />
            Track D
          </li>
        </ul>
      </div>
      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td>
              <select name="question4_a1" v-model="question4_a1" class="text-black">
          ...
          <tr>
            ...
            <td>
              <select name="question4_a2" v-model="question4_a2" class="text-black">
                <option disabled selected>[ Select ]</option>
                <option value="Correct">Correct</option>
                <option value="Incorrect">Incorrect</option>
              </select>
          ...
          <tr>
            ...
            <td>
              <select name="question4_a3" v-model="question4_a3"  class="text-black">
                <option disabled selected>[ Select ]</option>
                <option value="Correct">Correct</option>
                <option value="Incorrect">Incorrect</option>
              </select>
          ...
          <tr>
            ...
            <td>
              <select name="question4_a4" v-model="question4_a4"  class="text-black">
                <option disabled selected>[ Select ]</option>
                <option value="Correct">Correct</option>
                <option value="Incorrect">Incorrect</option>
              </select>
